...
3. **Model Training 🚀 & Testing 🎯**: Two tutorials cover the use of two models: XGBoost and neural networks. Refer to :doc:`notebooks/model_training_xgboost` and :doc:`notebooks/model_training_neuralnetwork`.
