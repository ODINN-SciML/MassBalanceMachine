...
from regions.RGI_11_Switzerland.scripts.geo_data.svf import merge_svf_into_ds

# Somehow the GPSConverter class import fails with relative imports
# so we use the full path here.
from regions.RGI_11_Switzerland.scripts.utils.wgs84_ch1903 import GPSConverter
