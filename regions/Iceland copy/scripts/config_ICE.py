# <------------------ GLAMOS DATA: ------------------>
# Point data
path_PMB_WGMS_raw = '/home/mburlet/scratch/data/DATA_MB/WGMS/Iceland/data/all-stake-measurements/'
#path_PMB_GLAMOS_w_raw = path_PMB_GLAMOS_raw + 'winter/'
#path_PMB_GLAMOS_a_raw = path_PMB_GLAMOS_raw + 'annual/'

path_PMB_WGMS_csv = '/home/mburlet/scratch/data/DATA_MB/WGMS/Iceland/csv/'
