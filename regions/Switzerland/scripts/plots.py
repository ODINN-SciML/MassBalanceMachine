...
def PlotPredictions(grouped_ids, y_pred, metadata_test, test_set, model):
    ...
    mse_annual, rmse_annual, mae_annual, pearson_corr_annual, r2_annual = model.evalMetrics(
    ...
    if 'winter' in grouped_ids.PERIOD.unique():
        ...
        mse_winter, rmse_winter, mae_winter, pearson_corr_winter, r2_winter = model.evalMetrics(
